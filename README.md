...
<img width="1822" height="592" alt="desktop niko logo" src="https://github.com/user-attachments/assets/13eae14d-0c3a-4a03-b5ad-6623a33360a7" />
<h1>Desktop Niko</h1>
...
## Features
- Meow sound on click (There are currently 8 variants available)
...
To create and export the project, I used Godot Engine Mono 4.5 to simplify creation and expansion, I did not use any additional plugins, so in theory it should be easy to compile.
