...
To create and export the project, I used Godot Engine Mono 4.6.1 to simplify creation and expansion.
It's probably wrong to use Godot for such purposes, but I tried to maximize performance.
- Download and install [Godot Mono 4.6.1](https://godotengine.org/)
...
- Done, you can edit, run and export Desktop Niko into executable
