...
const achievements : Dictionary = {
	"ten_clicks" = ["ACHIEVEMENT_1_NAME","ACHIEVEMENT_1_DESC","res://sprites/achievements/ten_clicks.png", false], # Name, description, icon, is description hidden before unlock
